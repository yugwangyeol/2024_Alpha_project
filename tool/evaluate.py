...
class GroundTruthLoader(object):
    ...
    ENTRANCE = 'enter'
    EXIT = 'exit'
    SHANGHAITECH = 'DAD_Jigsaw'
    SHANGHAITECH_LABEL_PATH = os.path.join(DATA_DIR, 'DAD_Jigsaw/testing/frame_masks')
    TOY_DATA = 'toydata'
...
def compute_auc_average(res, reverse, smoothing):
    ...
    file_name_dir = '/home/work/Alpha/Jigsaw-VAD/' + dataset +  '/testing/top_IR/frames'
