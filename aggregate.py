...
def video_label_length(dataset='DAD'):
    label_path = "../DAD/testing/frame_masks"
    video_length = {}
...
def remake_video_output(video_output, dataset='DAD'): 
    ...
    for i in range(len(video_l)):
        ...
        for fno in frame_l:
            ...
            # print(f"Processing frame {fno} in video {video}")
            # print(f"clip_record: {clip_record}")
            # print(f"video_ before update: {video_}")
            ...
            # print(f"video_ after update: {video_}")
            # print(f"video2_ after update: {video2_}")
        ...
        # print(f"non_ones for spatial: {non_ones}")
        ...
        # print(f"non_ones for temporal: {non_ones}")
...
def evaluate_auc(video_output, dataset='DAD'):
